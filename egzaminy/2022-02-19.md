...
- jakie parametry są a jakie nie są przekazywane przez EBGP, IBGP
    - ORIGIN - z jakiego protokołu przyszła dana ścieżka. Chyba przekazywany wszędzie.
    - AS_PATH - przez jakie AS przeszła już ta ścieżka. Przed przekazaniem ścieżki po EBGP, ASBR dodaje numer własnego AS. Chyba przekazywany wszędzie.
    - NEXT_HOP - gdzie mam dalej iś jak chcę się dostać do hosta z danej ścieżki. Zmieniane przy każdym hopie po EBGP. Zostaje bez zmian przy chodzeniu po IBGP. [sos](https://techhub.hpe.com/eginfolib/networking/docs/switches/K-KA-KB/15-18/5998-8164_mrg/content/ch15s07.html#v17910227).
    - LOCAL_PREF - ustawiane tylko jak pakiet leci po IBGP. Informacja nie opuszcza AS. Pozwala wybrać którym routerem puścić ruch na wyjściu z AS. [sos](https://techhub.hpe.com/eginfolib/networking/docs/switches/K-KA-KB/15-18/5998-8164_mrg/content/ch15s07.html).
    - ATOMIC_AGGREGATE - 
    - COMMUNITY
    - MED
    - ORIGINATOR_ID
